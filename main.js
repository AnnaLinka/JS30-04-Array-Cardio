...
// const medieval = inventors.filter(function (inventor) {
//   if(inventor.year >= 1500 && inventor.year <=1600) {
//     return true;
//   }
// })

const medieval = inventors.filter(inventor => (inventor.year >= 1500 && inventor.year <=1600));
console.table(medieval);
...
// const longestLive = inventors.sort(function(a, b) {
...
// const categoryLinks = Arrray.from(document.querySelectorAll('.mw-category a'));
